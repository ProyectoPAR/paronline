 ...
 * @author root
 */
public class ServletPop extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("Carrito.jsp");//obtenemos el dispatcher y lo direccionamos a la misma pagina
            HttpSession session = request.getSession(true);//se recupera la session
            ListaProductos carrito = (ListaProductos)session.getAttribute("carrito");//Obtenemos el carrito
